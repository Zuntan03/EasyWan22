...
echo v0.3.57> "%EASY_COMFYUI%\ComfyUi_Version.txt"
...
call :GITHUB_HASH_REQUIREMENTS kijai ComfyUI-WanVideoWrapper main 9b864b987bee7d498ab00eeed5dd973de33f062a
if %ERRORLEVEL% neq 0 ( popd & exit /b 1 )
