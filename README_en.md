...
Wan 2.2 **I2V-A14B** runs on Win PC with RAM 32GB, Geforce RTX 30x0 or later with VRAM 8GB.  
[Wan 2.2 **I2V-A14B** barely worked with **RAM 16GB**, Geforce **GTX 1660Ti VRAM 6GB**.](https://yyy.wpx.jp/2025/08/EasyWan22_I2V-A14B_Vram6GB_Ram16GB.mp4)  
All samples are generated in a RAM 64GB, Geforce RTX 3060 12GB environment.
...
2. Prepare an **empty folder** for installation at a shallow path like `C:/EasyWan22/` or `D:/EasyWan22/`, place `EasyWan22Installer.bat` there and run it.
	...
	- **A [Civitai](https://civitai.com/) API key is required for downloading necessary files, so please enter it following the on-screen instructions or [online guides](https://www.google.com/search?q=civitai+api+key).**

<!-- If you encounter problems during installation, please refer to the FAQ section "[Installation Fails](https://github.com/Zuntan03/EasyWan22/wiki/FAQ#installation-fails)". -->
...
**When doing seed gacha based on examples, please disable post-processing before gacha.**
...
- Added support for [`Detailer`](https://github.com/Zuntan03/EasyWan22/wiki/UI-PostProcess#detailer) that automatically detects areas, crops them, enlarges them, and then enhances them.
	- Can apply region-specific prompts like ADetailer.
